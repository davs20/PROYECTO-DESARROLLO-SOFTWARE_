<div class="container-fluid">
    ...
    <ol class="breadcrumb">
        ...
        <li><a class="active" href="#">Eliminar</a></li>
    </ol>
</div>
<div class="col-md-3"></div>
<div class="col-md-6">
    <div class="panel panel-default">
        <div class="panel-heading">Eliminar Precio de Habitaciones</div>
            ...
            <div class="col-md-10">
                <form method="post" action="" id="formulario_crear_precio">
                    <div class="col-sm-12">
                        ...
                        <input type="text" name="descripcion" id="nombre" required maxlength="255" class="form-control"/>
                    </div>
