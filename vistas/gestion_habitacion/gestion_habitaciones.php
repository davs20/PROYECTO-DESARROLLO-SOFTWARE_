    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <h3 class="page-header">
                <a class="btn btn-primary ajax-request" href="/gestion_habitacion/opciones/crear_habitacion.php">
                    <i class="fa fa-plus"></i> Nuevo Habitacion
                </a>
            </h3>
        </div>
    </div>
                ...
                <div class="panel-body">
                    <div class="col-md-12 box-body">
                        <table class="table table-bordered table-striped" id="datos" style="width: 100%">
                            ...
                            $stmt = $db->prepare("SELECT *  FROM habitacion");
                            $stmt->execute();
